# book-bot - Интерактивный бот для чтения

## Описание проекта

**book-bot** - это современный и удобный интерактивный бот для чтения книг, разработанный с использованием Python и aiogram. 
...
1. **Скачать репозиторий**
   ...
   ```csharp 
   git clone git@github.com:antsakharov/book-bot.git
   ```
